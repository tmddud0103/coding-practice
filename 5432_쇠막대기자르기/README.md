...
'(' 와 ')' 가  동시에 붙어서 존재한다면 (=인접한 쌍이라면)그것은 레이저라고 말 할수 있다

다시 말해, 헷갈리니까 () => B라고 표시하자(Beam)
...
```
B(((BB)(B)B))(B)
솔직히 첫번째 레이저는 쓸모가 없다 그러므로 지우도록 하겠다
(((BB)(B)B))(B)
```

![image-20210817153539077](photo/image-20210817153539077.png)
...
![image-20210817153842284](photo/image-20210817153842284.png)
...
![image-20210817153952414](photo/image-20210817153952414.png)
...
#### 	전체 토막의 개수 = 이전까지의 토막 개수 + 현재 존재하는 막대기의 개수



위의 아이디어를 이용해서 코드를 만든다
